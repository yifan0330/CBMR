...
def main(argv):
    ...
    # train = train_dataset(dataset=FLAGS.dataset, covariates=FLAGS.covariates, spacing=FLAGS.spacing, device=device)
    # train_model = train.train(model=FLAGS.model, penalty=FLAGS.penalty, iter=10000, lr=FLAGS.lr, tol=1e-9)
